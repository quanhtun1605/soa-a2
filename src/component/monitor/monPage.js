...
import Formpoint from "../student/formpoint";

class Monpage extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        Monpage.signOut = Monpage.signOut.bind(this);
    }
                ...
                <nav className="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
                    ...
                    <ul className="navbar-nav px-3">
                        <li className="nav-item text-nowrap">
                            <a className="nav-link" href="" onClick={Monpage.signOut}>
                                Sign out
                            </a>
                        </li>
                    </ul>
